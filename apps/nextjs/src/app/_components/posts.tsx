...
import { Field, FieldContent, FieldError, FieldGroup, FieldLabel } from '@acme/ui/field'
...
export function PostCardSkeleton(props: { pulse?: boolean }) {
	...
	return (
		<div className="bg-muted flex flex-row rounded-lg p-4">
			<div className="grow">
				<h2 className={cn('bg-primary w-1/4 rounded-sm text-2xl font-bold', pulse && 'animate-pulse')}>&nbsp;</h2>
				<p className={cn('mt-2 w-1/3 rounded-sm bg-current text-sm', pulse && 'animate-pulse')}>&nbsp;</p>
			</div>
		</div>
	)
}
